...
namespace TestProject_task2
{
    ...
    {
        [TestMethod]
        public void TestMethod1() //Сортировка в порядке возрастания сумм элементов строк матрицы
        {
            var matrix1 = new[,]
            {
                { 1, 1, 4},
        ...
        [TestMethod]
        public void TestMethod2() //Сортировка в порядке убывания сумм элементов строк матриц
        {
            var matrix2 = new[,]
            {
                { 9, -5, 6 },
        ...
        [TestMethod]
        public void TestMethod3() //Сортировка по возрастанию максимального элемента в строке матрицы
        {
            var matrix3 = new[,]
            {
                { 9, -5, 6 },
        ...
        [TestMethod]
        public void TestMethod4() //Сортировка по убыванию максимального элемента в строке матрицы
        {
            var matrix4 = new[,]
            {
                { 1, 1, 4, 5},
        ...
        [TestMethod]
        public void TestMethod5() //Сортировка в порядке возрастания минимального элемента в строке матрицы
        {
            var matrix5 = new[,]
            {
                { 9, -5, 6 },
        ...
        [TestMethod]
        public void TestMethod6() //Сортировка в порядке убывания минимального элемента в строке матрицы
        {
            var matrix6 = new[,]
            {
                { 1, 1, 4},
